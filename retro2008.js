...
(()=> {
  ...
  addPortal();q("#retroPlayNow")?.addEventListener("click",()=>q("#client-view")?.scrollIntoView({behavior:"smooth"}));mountAvatars();mountGear();replaceEmoji();observe();
})();